...
//				sb.append("<link rel=\"stylesheet\" href=\"plug-in/easyui/themes/icon.css\" type=\"text/css\"></link>");
			...
			//add by zhougang 2016-8-16  添加 提示确认框。
			if(oConvertUtils.isIn("comfirm", types)){
				sb.append("<link rel=\"stylesheet\" href=\"plug-in/jquery-plugs/comfirm/css/jquery.confirm.css\" type=\"text/css\"></link>");
				sb.append("<script type=\"text/javascript\" src=\"plug-in/jquery-plugs/comfirm/js/jquery.confirm.js\"></script>");
			}

...
public class SystemServiceImpl extends CommonServiceImpl implements SystemService {
	...
	public String getOrgName(String id) {
		String orgName = "";
		String pOrgCodeSql = "select t.departname from t_s_depart  t where t.id = ?"; 
		Map<String, Object> pOrgCodeMap = commonDao.findOneForJdbc(pOrgCodeSql, id.split(",")[0]);
		orgName = (String) pOrgCodeMap.get("departname");
		return orgName;
	}

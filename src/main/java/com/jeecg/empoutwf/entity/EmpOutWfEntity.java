package com.jeecg.empoutwf.entity;
 ...
 */
@Entity
@Table(name = "emp_out_wf", schema = "")
@SuppressWarnings("serial")
public class EmpOutWfEntity implements java.io.Serializable {
	/**主键*/
	...
	/**未打卡时间*/
	@Excel(name="未打卡时间")
	private java.lang.String betweenTime;
	...
	/**
	 *方法: 取得java.lang.String
	 *@return: java.lang.String  所属部门编号
	 */
	 ...
	 */
	@Column(name ="DEPTNAME",nullable=true,length=32)
	...
	/**
	 *方法: 取得java.lang.String
	 *@return: java.lang.String  未打卡时间
	 */
	@Column(name ="BETWEEN_TIME",nullable=true,length=32)
	public java.lang.String getBetweenTime(){
		return this.betweenTime;
	}

	/**
	 *方法: 设置java.lang.String
	 *@param: java.lang.String  未打卡时间
	 */
	public void setBetweenTime(java.lang.String betweenTime){

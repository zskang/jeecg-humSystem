...
<html>
 ...
 <body>
		<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="empOutWfController.do?doUpdate" tiptype="1" >
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
					<tr>
						...
						<td class="value">
						     	 <input id="empno" name="empno" type="text" style="width: 150px" class="inputxt"  value='${empOutWfPage.empno}'>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="empname" name="empname" type="text" style="width: 150px" class="inputxt"  value='${empOutWfPage.empname}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="orgno" name="orgno" type="text" style="width: 150px" class="inputxt"  value='${empOutWfPage.orgno}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="orgname" name="orgname" type="text" style="width: 150px" class="inputxt"  value='${empOutWfPage.orgname}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="deptno" name="deptno" type="text" style="width: 150px" class="inputxt"  value='${empOutWfPage.deptno}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="deptname" name="deptname" type="text" style="width: 150px" class="inputxt"  value='${empOutWfPage.deptname}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						  	 	<textarea id="reason" style="width:600px;" class="inputxt" rows="6" name="reason">${empOutWfPage.reason}</textarea>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
									  <input id="startDate" name="startDate" type="text" style="width: 150px" class="Wdate" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" value='<fmt:formatDate value='${empOutWfPage.startDate}' type="date" pattern="yyyy-MM-dd hh:mm:ss"/>'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
									  <input id="endDate" name="endDate" type="text" style="width: 150px" class="Wdate" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" value='<fmt:formatDate value='${empOutWfPage.endDate}' type="date" pattern="yyyy-MM-dd hh:mm:ss"/>'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="betweenTime" name="betweenTime" type="text" style="width: 150px" class="inputxt"  value='${empOutWfPage.betweenTime}'>
							<span class="Validform_checktip"></span>

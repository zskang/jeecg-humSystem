...
//导入
function ImportXls() {
	openuploadwin('Excel导入', 'empEducatInfoController.do?upload', "empEducatInfoList");
}

//导出
function ExportXls() {
	JeecgExcelExport("empEducatInfoController.do?exportXls","empEducatInfoList");
}

//模板下载
function ExportXlsByT() {
	JeecgExcelExport("empEducatInfoController.do?exportXlsByT","empEducatInfoList");
}
 </script>
...
<html>
 ...
 <body style="overflow-x: hidden;">
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" tiptype="1" action="jformResumeInfoController.do?doAdd" >
	...
	<table cellpadding="0" cellspacing="1" class="formtable">
		<tr>
			...
			<td class="value">
		     	 <input id="name" name="name" type="text" style="width: 150px" class="inputxt" required="required">
		  ...
		  <td class="value">
		     	 <input id="empNo" name="empNo" type="text" style="width: 150px" class="inputxt" readonly="readonly">
				<span class="Validform_checktip"></span>
	  ...
	  <tr>
			...
			<td align="right">
				<label class="Validform_label">所在岗位:</label>
			</td>
		  <td class="value"> 
				...
				<span class="Validform_checktip"></span>
				<label class="Validform_label" style="display: none;">所在岗位</label>
			</td>  
		</tr> 
		...
		<tr>
			...
			<td class="value" >
		     	 <input id="email" name="email" type="text" style="width: 150px" class="inputxt" required="required">
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
					<t:dictSelect field="degree" type="list"
						typeGroupCode="edu"  hasLabel="false"  title="最高学历"></t:dictSelect>     
				<span class="Validform_checktip"></span>
			...
			<td class="value">
					<t:dictSelect field="workyear" type="list"
						typeGroupCode="workyear"  hasLabel="false"  title="工作年限"></t:dictSelect>     
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
		     	 <input id="residence" name="residence" type="text" style="width: 150px" class="inputxt">
				<span class="Validform_checktip"></span>
			...
			<td class="value">
		     	 <input id="salary" name="salary" type="text" style="width: 150px" class="inputxt" required="required">
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
		     	 <input id="workPlace" name="workPlace" type="text" style="width: 150px" class="inputxt">
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
					<t:dictSelect field="mz" type="list"
						typeGroupCode="minzu"  hasLabel="false"  title="民族"></t:dictSelect>     
				<span class="Validform_checktip"></span>
			...
			<td class="value">
					<t:dictSelect field="jg" type="list"
						typeGroupCode="jiguan"  hasLabel="false"  title="籍贯"></t:dictSelect>     
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
					<t:dictSelect field="hyzk" type="list"
						typeGroupCode="marry"  hasLabel="false"  title="婚姻状况"></t:dictSelect>     
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
		     	 <input id="sg" name="sg" type="text" style="width: 150px" class="inputxt">cm
				<span class="Validform_checktip"></span>
			...
			<td class="value">
					<t:dictSelect field="jkzk" type="list"
						typeGroupCode="jkzk"  hasLabel="false"  title="健康状况"></t:dictSelect>     
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
					<t:dictSelect field="jszgz" type="list"
						typeGroupCode="jszgz"  hasLabel="false"  title="教师资格证"></t:dictSelect>     
				<span class="Validform_checktip"></span>
			...
			<td class="value">
					<t:dictSelect field="zcdj" type="list"
						typeGroupCode="postion"  hasLabel="false"  title="职称等级"></t:dictSelect>     
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
					<t:dictSelect field="wydj" type="list"
						typeGroupCode="wydj"  hasLabel="false"  title="外语等级"></t:dictSelect>     
				<span class="Validform_checktip"></span>
			...
			<td class="value">
					<t:dictSelect field="pthdj" type="list"
						typeGroupCode="pthdj"  hasLabel="false"  title="普通话等级"></t:dictSelect>     
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
		     	 <input id="jjlxrName" name="jjlxrName" type="text" style="width: 150px" class="inputxt">
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
		     	 <input id="jjlxrMobile" name="jjlxrMobile" type="text" style="width: 150px" class="inputxt">
				<span class="Validform_checktip"></span>
			...
			<td class="value">
		     	 <input id="ahtc" name="ahtc" type="text" style="width: 150px" class="inputxt">
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
					<t:dictSelect field="ypxz" type="list"
						typeGroupCode="ypxz"  hasLabel="false"  title="应聘性质"></t:dictSelect>     
				<span class="Validform_checktip"></span>
			...
			<td class="value">
					<t:dictSelect field="isChange" type="list"
						typeGroupCode="sf_yn"  hasLabel="false"  title="是否接受调动"></t:dictSelect>     
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
					<t:dictSelect field="infoSource" type="list"
						typeGroupCode="sourceType"  hasLabel="false"  title="信息来源"></t:dictSelect>     
				<span class="Validform_checktip"></span>
			...
			<td class="value">
		     	 <input id="habitation" name="habitation" type="text" style="width: 150px" class="inputxt">
				<span class="Validform_checktip"></span>

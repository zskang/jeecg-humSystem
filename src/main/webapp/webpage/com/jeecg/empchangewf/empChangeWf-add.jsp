...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="empChangeWfController.do?doAdd" tiptype="1" >
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
				...
				<tr>
					...
					<td class="value">
					     	 <input id="ruzhiDate" name="ruzhiDate" type="text" style="width: 150px" class="inputxt" >
							<span class="Validform_checktip"></span>
					...
					<td class="value">
					     	 <input id="sxDate" name="sxDate" type="text" style="width: 150px" class="inputxt" >
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="org1" name="org1" type="text" style="width: 150px" class="inputxt" >
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="dept1" name="dept1" type="text" style="width: 150px" class="inputxt" >
							<span class="Validform_checktip"></span>
					...
					<td class="value">
					     	 <input id="salary1" name="salary1" type="text" style="width: 150px" class="inputxt" >
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="butie1" name="butie1" type="text" style="width: 150px" class="inputxt" >
							<span class="Validform_checktip"></span>
					...
					<td class="value">
					     	 <input id="other1" name="other1" type="text" style="width: 150px" class="inputxt" >
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="org2" name="org2" type="text" style="width: 150px" class="inputxt" >
							<span class="Validform_checktip"></span>
					...
					<td class="value">
					     	 <input id="dept2" name="dept2" type="text" style="width: 150px" class="inputxt" >
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="salary2" name="salary2" type="text" style="width: 150px" class="inputxt" >
							<span class="Validform_checktip"></span>
					...
					<td class="value">
					     	 <input id="butie2" name="butie2" type="text" style="width: 150px" class="inputxt" >
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="other2" name="other2" type="text" style="width: 150px" class="inputxt" >
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="reqMobile" name="reqMobile" type="text" style="width: 150px" class="inputxt" >
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="reqDate" name="reqDate" type="text" style="width: 150px" class="inputxt" >
							<span class="Validform_checktip"></span>

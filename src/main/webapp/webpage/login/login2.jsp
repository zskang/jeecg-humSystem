...
<div align="center" class="container loginBg">
    ...
    <div class="login">
    	<ul class="titleName">
        	<li class="english">zskangOS</li>
            <li class="chinese">雷式人力资源管理系统</li>
        </ul>
        <ul class="loginInfo">
            <li>
	            <span>用户名：</span>
    ...
    <div class="copyright ">
    	<span>&copy; 绍康科技 版权所有 <span class="tip"><a href="#" title=JEECG 演示系统>zskangOS</a> (推荐使用IE8+,谷歌浏览器) 技术支持：:<a href="#" title=JEECG 演示系统>zskangOS</a></span></span>
    </div>       
</div>
</form>

...
<div class="easyui-layout" fit="true">
	<div region="center" style="padding:0px;border:0px">
		<t:datagrid name="categoryList" title="menu.subject.management"
			actionUrl="categoryController.do?datagrid" idField="id"
			treegrid="true" pagination="false" openFirstNode="true">
			...
			<t:dgCol title="common.type.code" field="code" treefield="id" hidden="true"></t:dgCol>

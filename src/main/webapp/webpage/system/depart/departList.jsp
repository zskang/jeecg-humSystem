...
<div id="main_depart_list" class="easyui-layout" fit="true">
    <div region="center" style="padding:0px;border:0px">
        <t:datagrid name="departList" title="common.department.list"
            ...
            <t:dgCol title="部门定员人数" field="hasCount" treefield="fieldMap.hasCount"></t:dgCol>
            <t:dgCol title="教学点" field="techPoint" treefield="fieldMap.techPoint"></t:dgCol>
            <t:dgCol title="利润点" field="moneyCenter" treefield="fieldMap.moneyCenter"></t:dgCol>

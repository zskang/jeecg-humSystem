...
<t:formvalid formid="formobj" layout="div" dialog="true" action="systemController.do?saveDepart">
	...
	<fieldset class="step">
        ...
        <div class="form">
            <label class="Validform_label"> 部门定员人数 : </label>
            <input id="hc" name="TSPDepart.hasCount" value="${depart.hasCount}">
        </div> 
        <div class="form">
            <label class="Validform_label"> 教学点 : </label>
            <input id="techPoint" name="TSPDepart.techPoint" value="${depart.techPoint}">
        </div> 
        <div class="form">
            <label class="Validform_label">利润中心 : </label>
            <input id="moneyCenter" name="TSPDepart.moneyCenter" value="${depart.moneyCenter}">
        </div>
        <div class="form">

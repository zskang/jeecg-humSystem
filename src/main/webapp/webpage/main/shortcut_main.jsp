...
<tr>
    <td align="left" style="vertical-align: text-bottom">
        <div style="position: absolute; top: 10px; left: 33px;"> <img alt="雷式人力资源管理系统" src="plug-in/login/images/administrator1.png"></div>
    <!-- <img src="plug-in/login/images/logo.jpg"> 
        <img src="plug-in/login/images/toplogo.png" width="550" height="52" alt="">-->
        <div style="position: absolute; top: 75px; left: 33px;">雷式人力资源管理系统 欢迎您！ </div>
    </td>

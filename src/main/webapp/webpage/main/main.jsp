...
<!-- 顶部 -->
<!-- title=" ZskangOS <t:mutiLang langKey="system.version.number"/>" <img src="plug-in/login/images/head.png;"> <img src="plug-in/login/images/foot.png">-->
<div region="north" border="false" title="欢迎登陆～" style="BACKGROUND: #E6E6FA; height: 85px; padding: 1px; overflow: hidden;">
<table width="100%" border="0" cellpadding="0" cellspacing="0">
<tr>
    <td align="left" style="vertical-align: text-bottom;"><span style="font-size:36px;color:666666;font-weight:bold;">雷式人力资源管理系统</span> </td>

...
<div class="container-fluid"><a class="brand" href="http://www.zskangOS.org" target="_blank"><t:mutiLang langKey="common.platform"/> &nbsp;&nbsp;<span class="slogan"></span></a>
...
<ul class="footer-links">
	<li style="display: inline;">&copy; <t:mutiLang langKey="common.copyright"/>雷式人力资源有限公司 信息部 提供支持</li>
</ul>
</div>
</footer>

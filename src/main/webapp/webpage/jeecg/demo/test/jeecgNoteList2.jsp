...
<div region="center" style="padding:0px;border:0px"><t:datagrid name="jeecgNoteList" title="单表模型" actionUrl="jeecgNoteController.do?datagrid" idField="id" fit="true" queryMode="group" queryBuilder="true">
	...
	<t:dgToolBar title="录入11" icon="icon-add" url="jeecgNoteController.do?addorupdate2" funname="doUrl" operationCode="add"></t:dgToolBar>
	<t:dgToolBar title="编辑00" icon="icon-edit" url="jeecgNoteController.do?addorupdate2" funname="updateNotCreateWin"></t:dgToolBar>
</t:datagrid>
